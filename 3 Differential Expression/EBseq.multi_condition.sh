...
# qsub -V -cwd -l h_vmem=4G -pe shm 12 -e DN_v_KO2_v_AzL.err -o DN_v_KO2_v_AzL.out ./RSEM-diff-express.multi_condition.sh
...
echo rsem-run-ebseq
rsem-run-ebseq $name.counts.matrix 1,1,1 $name.DE.results
...
rsem-control-fdr $name.DE.results 0.05 $name.DE_FDR05.txt
